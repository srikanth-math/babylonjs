import { CannonJSPlugin, CubeTexture, Engine, FreeCamera, MeshBuilder, PhysicsImpostor, Scene, SceneLoader, Vector3 } from "@babylonjs/core";
    ...
    CreateImpostors(): void {
      ...
      async CreateRocket(): Promise<void> {
        ...
        const rocketPhysics = () => {
            ...
            rocketCol.physicsImpostor!.setLinearVelocity(rocketCol.up.scale(50));
