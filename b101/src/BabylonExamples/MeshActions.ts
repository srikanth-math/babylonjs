import { AbstractMesh, ActionManager, Color3, CubeTexture, Engine, FreeCamera, IncrementValueAction, InterpolateValueAction, PBRMaterial, Scene, SceneLoader, SetValueAction, Vector3 } from "@babylonjs/core";
...
export class MeshActions{
    ...
    CreateScene():Scene{
        ...
        new FreeCamera("camera",new Vector3(0,1,-8),this.scene);
