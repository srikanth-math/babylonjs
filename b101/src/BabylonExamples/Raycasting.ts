import {Scene, Engine, FreeCamera, PBRMaterial, SceneLoader, AmmoJSPlugin, Vector3, MeshBuilder, PhysicsImpostor, Color3, CubeTexture, Texture, Matrix} from "@babylonjs/core";
...
export class Raycasting{
    ...
    async CreatePhysics(): Promise<void> {
        const ammo:any = await Ammo.bind(window)();
    ...
    CreatePickingRay():void{
        this.scene.onPointerDown=()=>{
            ...
            const raycastHit:any=this.scene.pickWithRay(ray);
